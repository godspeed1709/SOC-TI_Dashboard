...
|----------|------------|--------|-------------|----------|------------|-----------|--------|-------------|------|------------|
| APT-28 | 192.168.1.100 | /24 | C2 Server | Critical | 2024-01-15 | 2024-12-30 | Active | Command and Control server associated with APT-28 group targeting government entities | APT, C2, State-Sponsored | OSINT |
| Emotet Campaign | 10.20.30.40 | /32 | Malware Distribution | High | 2024-11-01 | 2024-12-25 | Active | Known Emotet malware distribution server | Malware, Banking Trojan, Botnet | Threat Feed |
...
| Ransomware-Group-X | 172.16.254.1 | /30 | Ransomware C2 | Critical | 2024-09-15 | 2024-12-15 | Blocked | Ransomware command and control infrastructure | Ransomware, C2, Encryption | Vendor Feed |
